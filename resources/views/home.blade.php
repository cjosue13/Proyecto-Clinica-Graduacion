                    ...
                    <div id='div_media'>
                        <nav>
                            <ul id='menu'>
                                ...
                                <a style=" outline:none;" href="{{ url('sistemadigestivos') }}"><button id="Button1" onmouseout="CambiarColor(this)" onmouseover="CambiarColor(this)" class="Button1" onclick="CambiarColor(this)"><i  style="outline:none; color: #209f85;" class="fas fa-id-card-alt"></i><br><label class="textocool2">Sistema Digestivo</label></button></a>
                                <a style=" outline:none;" href="{{ url('sistemanerviosos') }}"><button id="Button1" onmouseout="CambiarColor(this)" onmouseover="CambiarColor(this)" class="Button1" onclick="CambiarColor(this)"><i  style="outline:none; color: #209f85;" class="fas fa-id-card-alt"></i><br><label class="textocool2">Sistema Nervioso</label></button></a>
