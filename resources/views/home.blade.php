                    ...
                    <div id='div_media'>
                        <nav>
                            <ul id='menu'>
                                ...
                                <a style=" outline:none;" href="{{ route('auth') }}"><button id="Button1" onmouseout="CambiarColor(this)" onmouseover="CambiarColor(this)" class="Button1" onclick="CambiarColor(this)"><i     style="outline:none; color: #209f85;" class="fas fa-user-alt"></i><br><label class="textocool">Usuarios</label></button></a>
