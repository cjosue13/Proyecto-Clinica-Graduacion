...
<table class="table table-hover">
    ...
    <thead>
      ...
      <th>Nasofaringeo</th>
        <th width="140px" class="text-center">
          <a href="{{route('createAPAR', $exm_id)}}" class="btn btn-success btn-sm">
  ...
  <tr>
    ...
    <td>
      {!! Form::open(['method' => 'POST','route' => ['editAPAR', $value->apa_id, $exm_id],'style'=>'display:inline']) !!}
      <button type="submit" style="display: inline;" class="btn btn-hover btn-sm black-background">
        <i style="color: #ffffff;" class="fas fa-edit"></i>
      </button>
      {!! Form::close() !!}

      {!! Form::open(['method' => 'DELETE','route' => ['deleteAPAR', $value->apa_id, $exm_id],'style'=>'display:inline']) !!}
      <button type="submit" style="display: inline;" class="btn btn-hover btn-sm black-background">
