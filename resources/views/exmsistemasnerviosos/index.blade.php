...
<table class="table table-hover">
  <tr>
    <thead>
      ...
      <th width="140px" class="text-center">
        <a href="{{route('createESN', [$exm_id, $idCon, $idExp])}}" class="btn btn-success btn-sm">
  ...
  <tr>
    ...
    <td>
      {!! Form::open(['method' => 'POST','route' => ['editESN', $value->exSn_id, $exm_id, $idCon, $idExp],'style'=>'display:inline']) !!}
      <button type="submit" style="display: inline;" class="btn btn-hover btn-sm black-background">
        <i style="color: #ffffff;" class="fas fa-edit"></i>
      </button>
      {!! Form::close() !!}

      {!! Form::open(['method' => 'DELETE','route' => ['deleteESN', $value->exSn_id, $exm_id, $idCon, $idExp],'style'=>'display:inline']) !!}
      <button type="submit" style="display: inline;" class="btn btn-hover btn-sm black-background">
