...
<table class="table table-hover">
  ...
  <tr>
    ...
    <td>
      ...
      {!! Form::open(['method' => 'POST','route' => ['indexEx',$value->c_id],'style'=>'display:inline; margin-top: 10px;']) !!}
      <button type="submit" style="display: inline;" class="btn btn-hover btn-sm black-background">
        <i style="color: #ffffff;">Examenes</i>
      </button>
      {!! Form::close() !!}

      {!! Form::open(['method' => 'POST','route' => ['indexEC',$value->c_id],'style'=>'display:inline; margin-top: 10px;']) !!}
      <button type="submit" style="display: inline;" class="btn btn-hover btn-sm black-background">
